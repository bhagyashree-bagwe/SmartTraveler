...
public static String insertReview(String hotelName,String username,String hotelId, String city,String state,String reviewrating,String reviewdate,String reviewtext,String zipcode,String price)
{
	try
		{		
			getConnection();
